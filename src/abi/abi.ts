export const pxlpepes = [
  {
    inputs: [
      { internalType: 'string', name: '_initBaseURI', type: 'string' },
      { internalType: 'address', name: '_moonpepes', type: 'address' }
    ],
  ...
  {
    inputs: [{ internalType: 'address', name: '_moonpepes', type: 'address' }],
    name: 'setMoonPepesContract',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function'
  },
...
export const moonpepes = [
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_val1', type: 'uint256' }],
    name: 'setCommission',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function'
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint32', name: '_maxW', type: 'uint32' },
      { internalType: 'uint32', name: '_maxM', type: 'uint32' }
    ],
    name: 'updateSale',
    outputs: [],
    stateMutability: 'nonpayable',
